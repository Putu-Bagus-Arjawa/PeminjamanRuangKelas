...
const Dashboard = () => {
  ...
  const [reservations] = useState([
    { id: 1, nama: 'Bagus Arjuna S.kom, M.Kom', email: 'bagusarjuna@gmail.com', ruangan: 'Ruang 1.1', matkul: 'Kuliah', status: 'Disetujui', tanggal: '14/06/21' },
    { id: 2, nama: 'Bagus Arjuna S.kom, M.Kom', email: 'bagusarjuna@gmail.com', ruangan: 'Ruang 2.1', matkul: 'Kuliah', status: 'Menunggu', tanggal: '14/06/21' },
    { id: 3, nama: 'Bagus Arjuna S.kom, M.Kom', email: 'bagusarjuna@gmail.com', ruangan: 'Lab Kom 1', matkul: 'Praktek', status: 'Ditolak', tanggal: '14/06/21' },
    { id: 4, nama: 'Bagus Arjuna S.kom, M.Kom', email: 'bagusarjuna@gmail.com', ruangan: 'Ruang 2.3', matkul: 'Kuliah', status: 'Disetujui', tanggal: '14/06/21' },
    { id: 5, nama: 'Bagus Arjuna S.kom, M.Kom', email: 'bagusarjuna@gmail.com', ruangan: 'Ruang 1.2', matkul: 'Kuliah', status: 'Menunggu', tanggal: '14/06/21' },
    { id: 6, nama: 'Bagus Arjuna S.kom, M.Kom', email: 'bagusarjuna@gmail.com', ruangan: 'Ruang 3.4', matkul: 'Praktek', status: 'Menunggu', tanggal: '14/06/21' }
  ]);
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'Menunggu': return 'bg-gray-400';
      ...
      <div className="ml-64 p-8">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center space-x-4">
            <input type="text" placeholder="Type here" className="px-4 py-2 border rounded-lg" />
        ...
        <div className="grid grid-cols-4 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-xs text-gray-400 mt-1">Ruangan tersedia saat ini</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-xs text-gray-400 mt-1">Total reservasi disetujui</p>
          </div>
          
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-gray-500 text-sm">Reservasi Ditolak</h3>
            <p className="text-3xl font-bold text-gray-800">0</p>
            <p className="text-xs text-gray-400 mt-1">Total reservasi ditolak</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-4 gap-6">
            <div className="bg-white rounded-lg shadow overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-500">Ruang kelas Bawah Fasilitas</p>
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-500">Ruang Kelas Lantai 2 Fasilitas</p>
                <p className="text-xs text-gray-400">Kapasitas: 40</p>
              </div>
            </div>
            
            <div className="bg-white rounded-lg shadow overflow-hidden border-2 border-dashed border-gray-300 flex items-center justify-center h-48">
        ...
        <div className="bg-gradient-to-r from-teal-400 to-teal-500 rounded-lg p-8 mb-8">
          <h2 className="text-xl font-bold text-white text-center mb-6">FORM BOOKING RUANGAN</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* Upload Section */}
             <div className="col-span-3">
              ...
              <input type="file" className="w-full px-4 py-2 rounded bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-300 transition" />
            </div>
                  ...
                  <tr key={reservation.id} className="border-b">
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        ...
                        <div>
                          <p className="font-semibold text-gray-800">{reservation.nama}</p>
                          <p className="text-sm text-gray-500">{reservation.email}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 text-gray-800">{reservation.ruangan}</td>
                    <td className="px-6 py-4">
                      <div>
                    ...
                    <td className="px-6 py-4">
                      <span className={`px-3 py-1 rounded-full text-white text-sm font-medium ${getStatusColor(reservation.status)}`}>
                        {reservation.status}
                      </span>
                    </td>
                    <td className="px-6 py-4 text-gray-800">{reservation.tanggal}</td>
                  </tr>
                ))}
              </tbody>
            </table>
